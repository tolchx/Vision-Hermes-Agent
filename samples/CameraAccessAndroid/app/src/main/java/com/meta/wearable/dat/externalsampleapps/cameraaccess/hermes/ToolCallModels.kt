...
sealed class HermesConnectionState {
    data object NotConfigured : HermesConnectionState()
    data object Checking : HermesConnectionState()
    data object Connected : HermesConnectionState()
    data class Unreachable(val message: String) : HermesConnectionState()
}
